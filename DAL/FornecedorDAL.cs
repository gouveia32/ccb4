...
namespace DAL
{
    public class FornecedorDAL
    {
        ...
        //
        //
        public void Insere(Fornecedor modelo)
        {
            try
            {
                ...
                sql = "INSERT INTO fornecedores(nome,contato_funcao,contato_nome,cgc_cpf,inscr_estadual,endereco,cidade,estado,cep,telefone1,telefone2,telefone3,email,obs)"
        ...
        public void Altera(Fornecedor modelo)
        {
            try
            {
                ...
                sql = "UPDATE fornecedores SET nome=@nome,contato_funcao=@contato_funcao,contato_nome=@contato_nome,"
        ...
        public void Exclui(int id)
        {
            try
            {
                ...
                sql = "DELETE FROM fornecedores WHERE idUsuario = @id";
                bd.exeNonQuery(sql, p);
            }
            catch (Exception erro)
            {
        ...
        public DataTable Filtrar(String valor)
        {
            ...
            sql = "SELECT id, nome, contato_nome FROM fornecedores " + sWhere;
            return bd.exePesquisa(sql, p);
        }

        private Fornecedor BancoParaModelo(MySqlDataReader registro)
        {
